...
public class IotAccessRequest {
    ...
    public IotAccessRequest(){
        super();
    }

    public IotAccessRequest(String sub_username, String sub_user_password, String obj_dev_id, String obj_token,
                            String action, String env_info) {
